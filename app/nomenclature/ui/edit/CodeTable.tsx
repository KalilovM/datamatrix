                    ...
                    <td className="px-6 py-4 text-right flex items-center justify-end gap-2">
                      ...
                      {printTemplate && (
                        <button
                          ...
                          className="bg-white-500 px-2.5 py-2.5 text-white rounded-md cursor-pointer shadow-md ring ring-gray-300"
                        >
                          <PrintIcon className="size-5 stroke-blue-600 stroke-2" />
                        </button>
                      )}
                      <button
                        type="button"
